...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body class="bg-light">
    ...
    <nav class="navbar navbar-light bg-light">
      <a class="navbar-brand disabled" id="greeting"><?php echo ("Você está logado como Paciente. Olá, ".$user); ?></a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExample01">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="check_apps.php#" id="nav-link">Ver consultas</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="check_tests.php#" id="nav-link">Ver exames</a>
          </li>
          <li class="nav-item">
